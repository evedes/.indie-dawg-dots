...
# HexArchy Unified Launcher - combines apps and actions in one searchable view
...
# Launch rofi with the custom desktop directory added to the search path
XDG_DATA_DIRS="$TEMP_DIR:$XDG_DATA_DIRS" rofi \
    -show drun \
